...
const HistoryBar = () => {
    ...
    const getHistory = async () => {
        ...
        if (user_ID) {
            ...
            try {
                ...
                const response = await axios.post("http://minismallgpt.ap-1.evennode.com/history/send", { user_ID, searchTerm });
    ...
    const removeHistory = async () => {
        ...
        if (removeDetail) {
            try {
                const response = await axios.post("http://minismallgpt.ap-1.evennode.com/history/remove", { removeDetail })
